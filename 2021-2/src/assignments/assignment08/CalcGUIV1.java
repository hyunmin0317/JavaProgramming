...
public class CalcGUIV1 extends JFrame implements ActionListener {
    ...
    CalcGUIV1() {
        ...
        numberButton = new NumberButton(display, calculator);
        equalButton = new EqualButton(display, calculator);
        operatorButton = new OperatorButton(calculator);
